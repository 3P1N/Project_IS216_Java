...
public class DeleteAccount extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame2.setTitle("Xóa tài khoản");
        jInternalFrame2.setVisible(true);

        jButton5.setText("Xác nhận");

        jLabel1.setText("Bạn có chắc chắn muốn xóa tài khoản này vĩnh viễn không?");
        ...
        jInternalFrame1.setTitle("Thay đổi thành công");
